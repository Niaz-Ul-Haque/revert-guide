  ...
  [179],
  {
          ...
          !(function (e, t) {
            ...
            en
              ...
              : ((en = v.default.hydrateRoot(e, r, {
                ...
                (eo = !1));
          })(s, (e) => (0, g.jsx)(eu, { callbacks: [e, h], children: _ })),
          p
        );
      }
      async function ec(e) {
    ...
    9668: function (e, t, r) {
      ...
      async function N(e) {
        ...
        let { pathname: r } = (0, y.parsePath)(e.asPath),
          ...
          o = (0, E.addBasePath)((0, v.addLocale)(n, e.locale));
      ...
      class V {
        ...
        async change(e, t, r, n, o) {
          ...
          let en = r;
          et = et ? (0, a.removeTrailingSlash)((0, b.removeBasePath)(et)) : et;
          ...
          let ei = !!(
            ...
            es =
              !n.shallow &&
              (await N({ asPath: r, locale: G.locale, router: this }));
          if (
            (H && es && (W = !1),
            W &&
              "/_error" !== et &&
            ...
            return (q({ url: r, router: this }), !1);
          ((en = (0, P.removeLocale)((0, b.removeBasePath)(en), G.locale)),
          ...
          try {
            ...
            let l = n.shallow && G.route === (null != (w = a.route) ? w : eo),
              d = null != (O = n.scroll) ? O : !H && !l,
      ...
      (((t = {}).d = function (e, r) {
        ...
        (I = function (e, t) {
          ...
          ((r = _(e, u, a, t.reportAllChanges)),
            ...
            m &&
              l(function () {
                ((r = _(e, (u = d("FID")), a, t.reportAllChanges)),
                  (i = []),
                  (o = -1),
                  (n = null),
                  A(addEventListener),
        ...
        (W = function (e, t) {
          ...
          var n,
            ...
            a = function (e) {
              ...
              var t,
                r = ((t = Math.min(k.length - 1, Math.floor(F() / 50))), k[t]);
              r &&
                r.latency !== o.value &&
        ...
        (q = function (e, t) {
          ...
          if (s) {
            ...
            var u = function () {
              G[a.id] ||
                (i(s.takeRecords()), s.disconnect(), (G[a.id] = !0), r(!0));
            };
    ...
    5074: function () {
      ...
      class i extends n {
        ...
        messageSkipWaiting() {
          this._registration?.waiting && t(this._registration.waiting, a);
        }
        ...
        _onUpdateFound = (e) => {
          let t = this._registration,
            ...
            a =
              ...
              !o(n.scriptURL, this._scriptURL.toString()) ||
        ...
        _onStateChange = (e) => {
          let t = this._registration,
            n = e.target,
            { state: o } = n,
            a = n === this._externalSW,
            i = { sw: n, isExternal: a, originalEvent: e };
          (!a && this._isUpdate && (i.isUpdate = !0),
            this.dispatchEvent(new r(o, i)),
            "installed" === o
              ...
              : "activating" !== o ||
                ...
                a || this._activeDeferred.resolve(n)));
        };
