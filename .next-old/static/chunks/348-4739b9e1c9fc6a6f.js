  ...
  [348],
  {
        ...
        return (
          (0, n.useEffect)(() => {
            ...
            let t = new IntersectionObserver(
              (r) => {
                let [i] = r;
                i.isIntersecting && (l(!0), t.unobserve(e));
              },
    ...
    9835: function (e, t, r) {
      ...
      var i = r(7437),
        ...
        o = r(6543);
      function s(e) {
        let { children: t, className: r = "", href: o } = e,
          s =
            "block rounded-2xl border border-border/60 bg-white p-6 shadow-card transition-all duration-300 ease-out-expo page-break-avoid ".concat(
              r,
            );
        return o
          ? (0, i.jsx)(n.default, {
              ...
              className: "".concat(
                s,
                " no-underline hover:border-primaryGreen/60 hover:shadow-card-hover hover:-translate-y-1 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-borderStrong",
              ),
              children: t,
            })
          : (0, i.jsx)("div", { className: s, children: t });
      }
      function a(e) {
        let { title: t, stepNumber: r, timeEstimate: n, href: o } = e;
        return (0, i.jsx)(s, {
          href: o,
          className: "group",
      ...
      function u(e) {
        let { title: t, description: r, href: n, icon: o } = e;
        return (0, i.jsxs)(s, {
          href: n,
      ...
      function l(e) {
        let { title: t, description: r, type: n, url: a, locale: u = "en" } = e,
          l = (0, o.Ty)(u),
          d = a.startsWith("http");
        return (0, i.jsx)(s, {
          className: "group",
              ...
              children: [
                (0, i.jsxs)("div", {
                  ...
                  children: [
                    ...
                    (0, i.jsx)("span", {
                      className:
                        "inline-block rounded-full px-2.5 py-0.5 text-xs font-medium ".concat(
                          c[n],
                        ),
                      children: l("resources.types.".concat(n)),
                    }),
                  ],
                }),
                (0, i.jsx)("p", {
                ...
                (0, i.jsxs)("a", {
                  ...
                  ...(d
                    ...
                    : {}),
                  children: [
                    l(d ? "resources.visitResource" : "resources.viewResource"),
                    d &&
                      (0, i.jsx)("svg", {
    ...
    9323: function (e, t, r) {
      ...
      function a(e) {
        let { children: t, locale: r, messages: o } = e,
          a = (0, n.useMemo)(() => ({ locale: r, messages: o }), [r, o]);
